...
const NavBar = () => {
  return (
    <header className="lg:pl-28 grid grid-cols-1 lg:grid-cols-8 ">
      <div className="lg:col-span-6">
        <header className="p-4">
          ...
          <nav className="flex items-center justify-center gap-10 mb-6">
            <NavLink to="/categoria/masc" className="py-2 font-semibold uppercase  border-[#afddb8ff] border-b-2">
              Perfumes Masculinos
            </NavLink>
            <NavLink to="/categoria/fem" className="border-b py-2 font-semibold uppercase">
              Perfumes Femeninos
            </NavLink>
          </nav>
        </header>
